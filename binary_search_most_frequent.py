#Percobaan 11 Binary Search: Temukan elemen yang sering muncul paling banyak dalam sebuah list yang sudah diurutkan
def binary_search_most_frequent(data):
    ...
    while low <= high:
        ...
        while right < len(data) and data[right] == [mid]:
            count += 1
            right += 1
